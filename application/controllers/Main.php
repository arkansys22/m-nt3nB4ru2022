...
class Main extends CI_Controller {
	public function index()
	{
		...
		$this->data['post_gedung'] = $this->Crud_m->view_where_join_three_limit('harga', 'user_bisnis', 'user_company', 'kabupaten', 'id_harga', 'user_company_account', '6', array('user_company_judul' => 'Gedung'), 'RAND()');
